...
foreach ($databases as $database) {
    ...
    include_once("/var/www/html/lizola_college_new/college_sims/ajax/sms/sms.php");
    include_once("/var/www/html/lizola_college_new/college_sims/sms_apis/sms.php");
    include_once("/var/www/html/lizola_college_new/college_sims/connections/conn1.php");
