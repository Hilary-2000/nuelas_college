<div class="contents animate hide" id="settings_page">
    ...
    <div class="admWindow ">
        ...
        <div class="middle1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">System Login Hours</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Working Days</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Academic Calendar</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Admission Essentials</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Allow Classteacher to register students</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">User Roles</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Departments & Clubs</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">E-Mail Setup <span class="hide" id="load_email_setup"><img src="images/ajax_clock_small.gif" id=""></span></p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Expense Categories <span class="hide" id="expense_categories_loaders"><img src="images/ajax_clock_small.gif"></span></p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">Revenue Categories</p>
                </div>
                <div class="conts p-1 m-1">
            ...
            <div class="setting_s">
                <div class="bg-secondary mt-0">
                    <p class="text-center text-white">College Branches</p>
                </div>
                <div class="conts p-1 m-1">
