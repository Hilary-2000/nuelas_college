    ...
    <div class="admWindow">
        ...
        <div class="middle1">
            ...
            <div class="section_card">
                <p class="card_heading">Select Document to display</p>
            ...
            <div class="hide" id="income_statement_window">
                <div class="section_card">
                <p class="card_heading">Cash Flow Statement</p>
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="section_card results_card">
            ...
            <div class="hide" id="financial_performance">
                <div class="section_card">
                <p class="card_heading">Statement of Financial Performance</p>
                <form method="post" action="reports/reports.php" target="_blank" class="row">
                    <div class="col-md-4">
