                    ...
                    <div class="cont border border-secondary p-1 my-2 mx-2 d-none" id="message_tags_window">
                        ...
                        <div class="row w-90 mx-2">
                            <div class="conts p-2 bg-white my-2 col-md-6">
                                ...
                                <span><b>9. Student Admission: </b> <span class="mx-2">{stud_adm}</span> <span id="insert_tag14" class="text-left link" title="click to insert in message"><i class="fas fa-angle-double-down"></i></span> <small></small>
                            </div>
                            <div class="conts p-2 bg-white my-2 col-md-6">
